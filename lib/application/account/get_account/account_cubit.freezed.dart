...
class _$AccountStateTearOff {
  ...
  _LoadSuccess loadSuccess(Account account) {
    return _LoadSuccess(
      account,
    );
  }

  _LoadFailure loadFailure(AccountFailure failure) {
    return _LoadFailure(
      failure,
    );
  }
...
/// @nodoc
class __$LoadSuccessCopyWithImpl<$Res> extends _$AccountStateCopyWithImpl<$Res>
...
abstract class _LoadSuccess implements AccountState {
  const factory _LoadSuccess(Account account) = _$_LoadSuccess;
...
/// @nodoc
class __$LoadFailureCopyWithImpl<$Res> extends _$AccountStateCopyWithImpl<$Res>
...
abstract class _LoadFailure implements AccountState {
  const factory _LoadFailure(AccountFailure failure) = _$_LoadFailure;
