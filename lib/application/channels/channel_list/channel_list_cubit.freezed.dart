...
class _$ChannelListStateTearOff {
  ...
  _LoadSuccess loadSuccess(List<Channel> channels) {
    return _LoadSuccess(
      channels,
    );
  }

  _LoadFailure loadFailure(ChannelFailure channelFailure) {
    return _LoadFailure(
      channelFailure,
    );
  }
...
mixin _$ChannelListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Channel> channels) loadSuccess,
    required TResult Function(ChannelFailure channelFailure) loadFailure,
  }) =>
...
class _$_LoadFailure implements _LoadFailure {
  const _$_LoadFailure(this.channelFailure);

  @override
  final ChannelFailure channelFailure;
  ...
  TResult when<TResult extends Object?>({
    ...
    return loadFailure(channelFailure);
  }
