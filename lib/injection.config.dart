...
import 'application/account/change_password/change_password_cubit.dart' as _i44;
...
import 'application/auth/auth_status/auth_status_bloc.dart' as _i41;
import 'application/auth/forgot_password/forgot_password_cubit.dart' as _i58;
...
import 'application/channels/channel_list/channel_list_cubit.dart' as _i45;
import 'application/channels/create_channel/create_channel_cubit.dart' as _i47;
...
import 'application/channels/currently_typing/currently_typing_cubit.dart'
    as _i6;
import 'application/channels/delete_channel/delete_channel_cubit.dart' as _i52;
import 'application/channels/edit_channel/edit_channel_cubit.dart' as _i55;
import 'application/channels/get_private_channel_members/get_private_channel_members_cubit.dart'
    as _i62;
import 'application/dms/close_dm/close_dm_cubit.dart' as _i46;
import 'application/dms/current/current_dm_cubit.dart' as _i4;
import 'application/dms/dm_list/dm_list_cubit.dart' as _i50;
...
import 'application/friends/decline_request/decline_request_cubit.dart' as _i51;
import 'application/friends/get_friends/get_friends_cubit.dart' as _i60;
import 'application/friends/get_requests/get_requests_cubit.dart' as _i63;
...
import 'application/friends/send_friend_request/send_friend_request_cubit.dart'
    as _i34;
import 'application/guilds/create_guild/create_guild_cubit.dart' as _i48;
import 'application/guilds/current/current_guild_cubit.dart' as _i5;
import 'application/guilds/delete_guild/delete_guild_cubit.dart' as _i53;
import 'application/guilds/edit_guild/edit_guild_cubit.dart' as _i56;
import 'application/guilds/get_appearance/get_appearance_cubit.dart' as _i59;
import 'application/guilds/get_invite_link/get_invite_link_cubit.dart' as _i61;
import 'application/guilds/guild_list/guild_list_cubit.dart' as _i64;
...
import 'application/members/ban_list/ban_list_cubit.dart' as _i42;
...
import 'application/messages/create_message/create_message_cubit.dart' as _i49;
import 'application/messages/delete_message/delete_message_cubit.dart' as _i54;
import 'application/messages/download_image/download_image_cubit.dart' as _i7;
import 'application/messages/edit_message/edit_message_cubit.dart' as _i57;
...
import 'infrastructure/core/injectable_module.dart' as _i65;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i41.AuthStatusBloc>(
      () => _i41.AuthStatusBloc(get<_i11.IAuthFacade>()));
  gh.factory<_i42.BanListCubit>(
      () => _i42.BanListCubit(get<_i21.IMemberRepository>()));
  gh.factory<_i43.ChangeAppearanceCubit>(
      () => _i43.ChangeAppearanceCubit(get<_i21.IMemberRepository>()));
  gh.factory<_i44.ChangePasswordCubit>(
      () => _i44.ChangePasswordCubit(get<_i11.IAuthFacade>()));
  gh.factory<_i45.ChannelListCubit>(
      () => _i45.ChannelListCubit(get<_i13.IChannelRepository>()));
  gh.factory<_i46.CloseDMCubit>(
      () => _i46.CloseDMCubit(get<_i15.IDMRepository>()));
  gh.factory<_i47.CreateChannelCubit>(
      () => _i47.CreateChannelCubit(get<_i13.IChannelRepository>()));
  gh.factory<_i48.CreateGuildCubit>(
      () => _i48.CreateGuildCubit(get<_i19.IGuildRepository>()));
  gh.factory<_i49.CreateMessageCubit>(
      () => _i49.CreateMessageCubit(get<_i23.IMessageRepository>()));
  gh.factory<_i50.DMListCubit>(
      () => _i50.DMListCubit(get<_i15.IDMRepository>()));
  gh.factory<_i51.DeclineRequestCubit>(
      () => _i51.DeclineRequestCubit(get<_i17.IFriendRepository>()));
  gh.factory<_i52.DeleteChannelCubit>(
      () => _i52.DeleteChannelCubit(get<_i13.IChannelRepository>()));
  gh.factory<_i53.DeleteGuildCubit>(
      () => _i53.DeleteGuildCubit(get<_i19.IGuildRepository>()));
  gh.factory<_i54.DeleteMessageCubit>(
      () => _i54.DeleteMessageCubit(get<_i23.IMessageRepository>()));
  gh.factory<_i55.EditChannelCubit>(
      () => _i55.EditChannelCubit(get<_i13.IChannelRepository>()));
  gh.factory<_i56.EditGuildCubit>(
      () => _i56.EditGuildCubit(get<_i19.IGuildRepository>()));
  gh.factory<_i57.EditMessageCubit>(
      () => _i57.EditMessageCubit(get<_i23.IMessageRepository>()));
  gh.factory<_i58.ForgotPasswordCubit>(
      () => _i58.ForgotPasswordCubit(get<_i11.IAuthFacade>()));
  gh.factory<_i59.GetAppearanceCubit>(
      () => _i59.GetAppearanceCubit(get<_i21.IMemberRepository>()));
  gh.factory<_i60.GetFriendsCubit>(
      () => _i60.GetFriendsCubit(get<_i17.IFriendRepository>()));
  gh.factory<_i61.GetInviteLinkCubit>(
      () => _i61.GetInviteLinkCubit(get<_i19.IGuildRepository>()));
  gh.factory<_i62.GetPrivateChannelMembersCubit>(
      () => _i62.GetPrivateChannelMembersCubit(get<_i13.IChannelRepository>()));
  gh.factory<_i63.GetRequestsCubit>(
      () => _i63.GetRequestsCubit(get<_i17.IFriendRepository>()));
  gh.factory<_i64.GuildListCubit>(
      () => _i64.GuildListCubit(get<_i19.IGuildRepository>()));
  return get;
}

class _$InjectableModule extends _i65.InjectableModule {}
