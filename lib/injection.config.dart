...
import 'application/auth/forgot_password/forgot_password_cubit.dart' as _i43;
...
import 'application/channels/channel_list/channel_cubit.dart' as _i38;
...
import 'application/channels/currently_typing/currently_typing_cubit.dart'
    as _i5;
import 'application/dms/dm_list/dm_list_bloc.dart' as _i40;
import 'application/dms/start_dm/start_dm_cubit.dart' as _i31;
import 'application/friends/get_friends/get_friends_cubit.dart' as _i45;
...
import 'application/guilds/get_appearance/get_appearance_cubit.dart' as _i44;
import 'application/guilds/guild_list/guild_list_cubit.dart' as _i46;
...
import 'application/messages/create_message/create_message_cubit.dart' as _i39;
import 'application/messages/delete_message/delete_message_cubit.dart' as _i41;
import 'application/messages/download_image/download_image_cubit.dart' as _i6;
import 'application/messages/edit_message/edit_message_cubit.dart' as _i42;
...
import 'infrastructure/core/injectable_module.dart' as _i47;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i38.ChannelCubit>(
      () => _i38.ChannelCubit(get<_i12.IChannelRepository>()));
  gh.factory<_i39.CreateMessageCubit>(
      () => _i39.CreateMessageCubit(get<_i22.IMessageRepository>()));
  gh.factory<_i40.DMListBloc>(() => _i40.DMListBloc(get<_i14.IDMRepository>()));
  gh.factory<_i41.DeleteMessageCubit>(
      () => _i41.DeleteMessageCubit(get<_i22.IMessageRepository>()));
  gh.factory<_i42.EditMessageCubit>(
      () => _i42.EditMessageCubit(get<_i22.IMessageRepository>()));
  gh.factory<_i43.ForgotPasswordCubit>(
      () => _i43.ForgotPasswordCubit(get<_i10.IAuthFacade>()));
  gh.factory<_i44.GetAppearanceCubit>(
      () => _i44.GetAppearanceCubit(get<_i18.IGuildRepository>()));
  gh.factory<_i45.GetFriendsCubit>(
      () => _i45.GetFriendsCubit(get<_i16.IFriendRepository>()));
  gh.factory<_i46.GuildListCubit>(
      () => _i46.GuildListCubit(get<_i18.IGuildRepository>()));
  return get;
}
